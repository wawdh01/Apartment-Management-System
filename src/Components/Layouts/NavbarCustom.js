                ...
                }
                {
                    loggedIn === true && (
                        <>
                            ...
                            <Nav.Link eventKey={7} href="/contact">Contacts</Nav.Link>
                            {
                                loginType === 1 ?
                                <Nav.Link eventKey={8} href="/register">Register</Nav.Link>:
                                <></>
                            }
                            {
                                loginType === 1 ?
                                <Nav.Link eventKey={9} href="/adminMaintenance">AdminMaintenance</Nav.Link>:
                                <></>
                            }
                            <LogOutBtn></LogOutBtn>
                        </>
